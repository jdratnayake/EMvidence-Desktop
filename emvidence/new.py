...
from PyQt5.QtGui import QIcon, QRegExpValidator,QValidator, QPalette, QColor, QTextCursor, QMovie
...
class my_app(QMainWindow):
    def __init__(self):
        ...
        # change progressbar into loading icon
        self.ui.loading.setVisible(False)
        # self.ui.progressBar.setVisible(False)



        # movie = QMovie('loading icon.gif')
